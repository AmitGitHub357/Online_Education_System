...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2019 at 01:22 PM
...
(2, 'Admin', 'admin@gmail.com', 'Admin', 'SuperAdmin', 'Active', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(8, '', 'Active', '2019-12-14 02:38:27', '0000-00-00 00:00:00');
...
INSERT INTO `contact_us` (`Contact_id`, `User_Name`, `User_Email`, `User_Mobile`, `User_Subject`, `User_Message`, `Contact_Status`, `Contact_Entry_Date`) VALUES
(1, 'Tushar Sonar', 'tushara4948@gmail.com', 7048732935, '', 'This is good Website', 'Active', '0000-00-00 00:00:00');
...
(42, 'IOS', 20000, 15, 7, 'Images/IMG_20191211_145645620~2.jpg', 'This is ios', 'Active', '2019-12-15 03:46:24', '0000-00-00 00:00:00');
...
CREATE TABLE `events` (
  ...
  `Event_Status` enum('Pending','Done') NOT NULL DEFAULT 'Pending',
...
(1, 'Cricket', '2020-11-01', '23:59:00', 'Surat', 'This is Cricket.', 'Images/avatar-03.jpg', 'Pending', '2019-12-07 12:34:49', '0000-00-00 00:00:00'),
(2, 'Sport', '2018-12-31', '23:59:00', 'Bharuch', 'This is Sport', 'Images/avatar-05.jpg', 'Done', '2019-12-07 12:59:36', '0000-00-00 00:00:00'),
(3, 'Annual Function', '2019-12-31', '19:00:00', 'Disco', 'This is the annual function.', 'Images/Annual.png', 'Pending', '2019-12-13 02:08:26', '0000-00-00 00:00:00'),
(4, 'Annual Function', '2019-12-31', '19:00:00', 'Town Hall', 'This is the annual function', 'Images/Annual.png', 'Pending', '2019-12-13 04:00:58', '0000-00-00 00:00:00'),
(5, 'X-Mus Party', '2019-12-25', '00:00:00', 'Party Plot', 'This is party organize to celebrate X-mus.', 'Images/WoodenBackground - Copy.jpg', 'Pending', '2019-12-13 11:00:39', '0000-00-00 00:00:00');
...
(1, 4, '2019-12-15 23:30:00', 39, 'Taken', '2019-12-04 12:31:29', '2019-12-14 03:27:46'),
(2, 6, '2019-12-16 15:00:00', 41, 'Taken', '2019-12-07 11:09:02', '2019-12-16 03:26:31'),
(3, 6, '2019-12-07 15:00:00', 40, 'Taken', '2019-12-07 11:21:00', '0000-00-00 00:00:00'),
(5, 6, '2019-12-24 12:30:00', 39, 'Pending', '0000-00-00 00:00:00', '2019-12-16 10:57:14'),
(6, 4, '2019-12-16 00:00:00', 39, 'Taken', '2019-12-13 02:00:06', '0000-00-00 00:00:00'),
(7, 4, '2019-12-16 10:00:00', 39, 'Taken', '2019-12-13 03:58:01', '2019-12-16 10:54:38'),
(8, 4, '2019-12-16 15:00:00', 40, 'Taken', '2019-12-15 10:52:56', '2019-12-16 03:27:55'),
(9, 6, '2019-12-16 15:00:00', 39, 'Taken', '2019-12-16 10:58:38', '2019-12-16 03:13:15'),
(10, 6, '2019-12-17 11:00:00', 41, 'Pending', '2019-12-17 10:45:36', '0000-00-00 00:00:00'),
(11, 4, '2019-12-17 10:00:00', 41, 'Taken', '2019-12-17 10:46:40', '0000-00-00 00:00:00'),
(12, 6, '2019-12-17 12:00:00', 39, 'Pending', '2019-12-17 12:22:11', '0000-00-00 00:00:00');
...
INSERT INTO `material` (`Material_id`, `Material_File`, `Lecture_No`, `User_id`, `Course_id`, `Material_Status`, `Material_Entry_Date`) VALUES
(7, 'Images/ict3_Syllabus.pdf', 1, 3, 39, 'Active', '2019-12-07 04:09:55'),
(8, 'Images/M.Sc. ICT Sem.2.pdf', 2, 1, 39, 'Active', '2019-12-07 04:16:25'),
(9, 'Images/Python.pdf', 1, 1, 41, 'Active', '2019-12-07 03:29:53'),
(10, 'Images/PHP.pdf', 3, 1, 39, 'Active', '2019-12-13 02:35:47'),
(11, 'Images/php_tutorial.pdf', 4, 1, 39, 'Active', '2019-12-16 11:13:01'),
(12, 'Images/M.Sc. ICT Sem.1.pdf', 1, 9, 39, 'Active', '2019-12-17 12:24:14');
...
(3, 6, 'Who is the father of PHP', 'Rasmus Lerdorf', 'Willam Makepiece', 'Drek Kolkevi', 'List Barely', 'Rasmus Lerdorf', 'Active', '2019-12-16 02:11:01', '0000-00-00 00:00:00'),
(4, 9, 'Who is the father of PHP', 'Rasmus Lerdorf', 'Willam Makepiece', 'Drek Kolkevi', 'List Barely', 'Rasmus Lerdorf', 'Active', '2019-12-16 11:03:59', '0000-00-00 00:00:00'),
(5, 11, 'What will be the output of the following Python code?  print(\"Hello {name1} and {name2}\".format(name', 'Hello foo and bin', 'Hello {name1} and {name2}', 'Error', 'Hello', 'Hello foo and bin', 'Active', '2019-12-17 10:51:39', '0000-00-00 00:00:00'),
(6, 10, 'What will be the output of the following Python code?  print(\"Hello {0!r} and {0!s}\".format(\'foo\', \'', 'Hello foo and foo', 'Hello \'foo\' and foo', 'Hello foo and \'bin\'', 'Error', 'Hello \'foo\' and foo', 'Active', '2019-12-17 10:55:17', '0000-00-00 00:00:00'),
(7, 10, ' Is Python case sensitive when dealing with identifiers?', 'Yes', 'No', 'Machin Dependent', 'None of above', 'Yes', 'Active', '2019-12-17 10:57:58', '0000-00-00 00:00:00'),
(8, 10, 'What is the maximum possible length of an identifier?', '31', '63', '79', 'None Of Above', 'None Of Above', 'Active', '2019-12-17 10:58:55', '0000-00-00 00:00:00'),
(9, 10, 'Which of the following is invalid?', '_a =1', '__a = 1', '__str__ = 1', 'None of above', 'None of above', 'Active', '2019-12-17 11:00:52', '0000-00-00 00:00:00'),
(10, 10, 'Which of the following is an invalid variable?', 'my_string_1', '1st_string', 'foo', '_', '1st_string', 'Active', '2019-12-17 11:01:46', '0000-00-00 00:00:00'),
(11, 10, 'Why are local variable names beginning with an underscore discouraged?', 'they are used to indicate a private variables of a', 'they confuse the interpreter', ' they are used to indicate global variables', 'they slow down execution', 'they are used to indicate a private variables of a', 'Active', '2019-12-17 11:02:37', '0000-00-00 00:00:00'),
(12, 10, 'Which of the following is not a keyword?', 'eval', 'assert', 'nonlocal', 'pass', 'eval', 'Active', '2019-12-17 11:03:43', '0000-00-00 00:00:00'),
(13, 10, 'All keywords in Python are in _________', 'lower case', 'UPPERCASE', 'Capitalize', 'None of above', 'None of above', 'Active', '2019-12-17 11:04:30', '0000-00-00 00:00:00'),
(14, 10, 'Which of the following is true for variable names in Python?', 'unlimited length', 'all private members must have leading and trailing', ' underscore and ampersand are the only two special', 'None of above', 'unlimited length', 'Active', '2019-12-17 11:05:33', '0000-00-00 00:00:00'),
(15, 10, ' Which of the following cannot be a variable?', '__init__', 'in', 'it', 'on', 'in', 'Active', '2019-12-17 11:06:19', '0000-00-00 00:00:00'),
(16, 12, 'Who is the father of PHP', 'Rasmus Lerdorf', 'Willam Makepiece', 'Drek Kolkevi', 'List Barely', 'Rasmus Lerdorf', 'Active', '2019-12-17 12:25:46', '0000-00-00 00:00:00');
...
INSERT INTO `results` (`Result_id`, `Exam_id`, `User_id`, `Marks`, `Result_Status`, `Result_Entry_Date`) VALUES
(1, 1, 6, 2, 'Active', '0000-00-00 00:00:00'),
(2, 1, 6, 2, 'Active', '0000-00-00 00:00:00'),
(3, 1, 6, 1, 'Active', '0000-00-00 00:00:00'),
(4, 1, 6, 1, 'Active', '2019-12-16 01:47:38'),
(5, 1, 5, 2, 'Active', '2019-12-16 01:54:55'),
(9, 9, 6, 1, 'Active', '2019-12-16 03:15:45'),
(10, 11, 8, 1, 'Active', '2019-12-17 12:29:54'),
(11, 12, 8, 1, 'Active', '2019-12-17 12:31:51'),
(12, 10, 8, 4, 'Active', '2019-12-17 12:32:44'),
(13, 12, 6, 1, 'Active', '2019-12-17 12:59:20');
...
(12, 'Goa', 'Active', '0000-00-00 00:00:00', '2019-12-17 12:35:37'),
...
INSERT INTO `syllabus` (`Syllabus_id`, `File_Name`, `Syllabus_PDF`, `Course_id`, `Syllabus_Status`, `Syllabus_Entry_Date`) VALUES
(5, '', 'M.Sc. ICT Sem.2.pdf', 39, 'Active', '0000-00-00 00:00:00');
...
(6, 'pqr@gmail.com', 'PQR_2019', 'PQR', 7048732935, 'Male', '2019-12-31', 'Images/ProfilePhotos/images (3).jpeg', 'Mumbai', 7, 'Student', 'Active', '2019-12-07 02:56:48', '0000-00-00 00:00:00'),
...
(8, 'aashish@gmail.com', 'Aashish_1997', 'Aashish', 9876543210, 'Male', '1997-01-01', NULL, 'Varachha', 7, 'Student', 'Active', '2019-12-17 10:41:52', '0000-00-00 00:00:00'),
(9, 'rockys4948@gmail.com', 'Rocky_1988', 'Rocky', 7048732935, 'Male', '1988-05-18', NULL, NULL, 6, 'Teacher', 'Active', '2019-12-17 12:19:49', '0000-00-00 00:00:00');
...
(5, 39, 'Pursuing', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 41, 'Pursuing', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, 39, 'Pursuing', '2019-12-17 10:41:52', '0000-00-00 00:00:00'),
(8, 41, 'Pursuing', '2019-12-17 10:41:52', '0000-00-00 00:00:00'),
(9, 39, 'Pursuing', '2019-12-17 12:19:49', '0000-00-00 00:00:00'),
(9, 41, 'Pursuing', '2019-12-17 12:19:49', '0000-00-00 00:00:00');
