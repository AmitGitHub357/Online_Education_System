                        ...
                        <div class="login-form">
                            <form action="" method="post" data-parsley-validate="">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" placeholder="Email" name="Username" required="" data-parsley-required-message="Please Enter Your Email">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="Password" placeholder="Password" required="" data-parsley-required-message="Please Enter Your Password">
                                </div>
