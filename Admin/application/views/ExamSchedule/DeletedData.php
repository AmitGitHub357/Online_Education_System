<div class="row">
	<div class="col-md-12">
		<!-- DATA TABLE -->
		<h3 class="title-5 m-b-35">Deleted Exam Schedule</h3>
							...
							<tr>
								...
								<td>
									<div class="table-data-feature">
										...
										<a href="<?php echo base_url()."index.php/ExamSchedule/DeleteExamSchedule/".$Exam['Exam_id'] ?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
											<i class="zmdi zmdi-delete" style="color: red"></i>
										</a>
										<a href="<?php echo base_url()."index.php/ExamSchedule/ExamStatus/".$Exam['Exam_id']."/Pending" ?>" class="item" data-toggle="tooltip" data-placement="top">
