	...
	<div class="col-md-12">
		...
		<div class="table-data__tool">
			<div class="table-data__tool-right">
				<a href="<?php echo base_url().'index.php/Syllabus/AddSyllabus/' ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
					<i class="zmdi zmdi-plus"></i>Upload Syllabus</a>
					...
					<tbody>
						...
						foreach ($Syllabuses as $Syllabus) {
							...
							<tr>
								...
								<td>
									<a href="<?php echo base_url().'Images/'.$Syllabus['Syllabus_PDF'] ?>" target="_blank">
