                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="Category_Name" placeholder="Enter Category Name..." class="form-control" required="" data-parsley-required-message="Please Enter Category Name">
                            </div>
                        </div>
                    
                </div>
                <div class="card-footer">
                    <button name="AddCategory" class="btn btn-primary btn-sm">
